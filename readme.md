...
- Scoring: UC-like (no falsi Crohn da skip lesions)
...
- [ ] Sigma LGD (no flogosi) + pattern UC resto → NO skip lesions ✅
...
- [ ] Pattern aspecifico (Crohn <50, UC <50) → IBDU dominante ✅
...
const calculateIBDUScore = (rawScores, topoPattern) => {
    ...
    // - Pattern contraddittori (granulomi + UC-like)
    // - Score equiparati
    // - Pattern aspecifico
    // NO "resto da 100"
};
...
- v3.0.2: Pattern continuo UC ✅

#### BUG #2: IBDU Matematica Incoerente
**Scenario**: Crohn raw 200, UC raw 100
